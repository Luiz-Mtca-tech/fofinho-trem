...
<body>
	...
	<div class="menu" id="menu">
		...
		<div class="menu-cadastrar" id="menu-cadastrar">
			...
			<ul class="log-cad" id="log-cad" name="log-cad">
				...
				<li>
					<?php
					    // aqui vou verificar o nivel do usuario, para que assim
					    // o sistema posso liberar certos privilégios ao usuario 
				        if(isset($_SESSION['nivel'])){
		                            //esta função tem uma explicação   
	...
	<div id="formulario">
		...
		if (isset($_SESSION['usuario']) && isset($_SESSION['senha'])){
		    echo '<p style="color:  #FBFF8C;">Bem Vindo!'.$_SESSION['usuario'].', para deslogar clique no botão vermelho acima!</p>';
		}
		?>
	</div>
